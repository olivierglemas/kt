...
export class DealsService {
  ...
  public getListingData(): Observable<DealsListingModel> {
    ...
    const dealsListingModel = {
      items: [
        {
          slug: '50-off-lindt',
          code: 'Docteur Généraliste',
          description: 'Lindt Excellence 70% Cocoa Chocolate Diamonds 60ct Box with Lancaster for $10.26',
          name: 'Dr Valdez Daza',
          // Relative date (better to showcase UI micro-interactions)
          expirationDate: dayjs().add(6, 'day').add(8, 'hour').add(10, 'second').format('MM/DD/YYYY HH:mm:ss') as string,
          // Instead of hardcoded one
          // expirationDate: '12/01/2018',
          logo: './assets/sample-images/deals/Deals1-4.1.png',
          location: {
            address: '1900 Powell Street',
            city: 'San Fransisco, CA, United States',
            latlng: '37.8021216,-122.4134178',
            mapImage: './assets/sample-images/food/food-details-map.png'
          },
        } as DealsItemModel,
        {
  ...
  public getDetailsData(): Observable<DealsDetailsModel> {
    ...
    const dealsDetailsModel = {
      ...
      // expirationDate: '12/01/2018',
      location: {
        address: '86 tres Picos',
        city: 'Mexico, CDMX, Mexico',
        latlng: '19.4243792,-99.2041711,15',
        mapImage: './assets/sample-images/food/food-details-map.png'
      },
      relatedDeals: [
        {
